	...
	if (src != NULL)
	{
		...
		if (header != NULL)
		{
			...
			if (data != NULL)
			{
				...
				std::cerr << "Failure locking resource. Last Error: " << GetLastError() << std::endl;
#endif
			...
			std::cerr << "Failure finding resource. Last Error: " << GetLastError() << std::endl;
#endif
		...
		std::cerr << "Failure loading resource. Last Error: " << GetLastError() << std::endl;
#endif
