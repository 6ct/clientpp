...
constexpr unsigned char rpc_update = 0, rpc_clear = 1, rpc_init = 2,
                        ...
                        browse_file = 9, mousedown = 10, mouseup = 11,
                        mousemove = 12, mousewheel = 13, pointer = 14,
                        open_devtools = 15, log = 16, relaunch_webview = 17,
                        close_window = 18, reload_window = 19, seek_game = 20,
