...
export default class Control extends Events {
  constructor(name, data, category) {
    ...
    this.content = utils.add_ele("div", this.category.content, {
      className: "settName",
    });
...
class SelectControl extends Control {
  static id = "select";
  create() {
    this.select = utils.add_ele("select", this.content, {
...
class SliderControl extends Control {
  ...
  create() {
    ...
    this.input.addEventListener(
      "focus",
      () => ((this.input_focused = true), this.interact())
    );
    this.input.addEventListener(
      "blur",
      () => ((this.input_focused = false), this.interact())
    );

    this.slider.addEventListener("input", () =>
      this.interact((this.value = this.slider.value))
    );
    this.input.addEventListener("input", () =>
      this.interact((this.value = +this.input.value))
    );
  }
  interact() {
    var label =
