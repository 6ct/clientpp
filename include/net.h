...
buffer_t fetch_request(const url &dest_url, const std::wstring &username = L"", const std::wstring &password = L"", const std::wstring &user_agent = L"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko)");
